...
switch (project.trlfinal.trllevel) {
    ...
    default:
        console.log("No valid TRls");
                                ...
                                <section><a href="{{ url('/searchProjectsByTechArea' , ['id' => $projOrg->techreferred->techarea->id])) }}" style="color:black;">{{$projOrg->techreferred->techarea->code}} {{$projOrg->techreferred->techarea->techarea}}</a></section>
                                <div class="row ml-1">
                                ...
                                <section style="margin-left:5px;"><a href="{{ route('projectTargetClickingPage', ['id' => $projOrg->project_target->id]) }}"
