...
<div class="faq-container">
    ...
    <div class="faq-item">
        <div class="faq-question" onclick="toggleAnswer(this)"> <span class="float-left-text" style="float: left;color: white; margin-right: 10px; margin-left: 0;">7</span><span class="faq-question">Drass mission type 1</span><i class="fas fa-chevron-right custom-icon-arrow"></i></div>
        <div class="faq-answer" style="display: none;"><div class="dropdown show">
        <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color: white; border: 1px solid grey; color: black;font-size: 14px;">
    Relevance
</a> 
...
<div class="faq-container">
    ...
    <div class="faq-item">
        <div class="faq-question" onclick="toggleAnswer(this)"> <span class="float-left-text" style="float: left;color: white; margin-right: 10px; margin-left: 0;">8</span><span class="faq-question">Drass mission type 1</span><i class="fas fa-chevron-right custom-icon-arrow"></i></div>
        <div class="faq-answer" style="display: none;"><div class="dropdown show">
        <a class="btn btn-secondary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color: white; border: 1px solid grey; color: black;font-size: 14px;">
    Relevance
</a> 
