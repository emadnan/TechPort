...
<body>
    ...
    <div class="container mt-4">
        ...
        <ul class="breadCrumbs mt-2 mb-0">
            ...
            <li class="breadCrumbs-items">></li>
            <li class="breadCrumbs-items"><a href="{{url('/found-sources-clicking')}}">{{$projOrg->name}}</a></li>
        </ul>
...
let numberOfProjects = 0;
    ...
    var baseUrl = '/getProjectsLengthBySourceID';
    var sourceID = projOrg.id;
    var trlID = trl.id;
    var url = baseUrl + '/' + sourceID + '/' + trlID;
