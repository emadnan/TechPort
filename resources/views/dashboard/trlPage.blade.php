        ...
        <div class="modal-body">
            <form id="form">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <textarea id="trldescription" type="text" class="form-control @error('trldescription') is-invalid @enderror" name="trldescription" value= "{{ old ('trldescription') }}" autocomplete="trldescription" autofocus></textarea>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        // Check if the element with ID "menu_techreferred" exists.
            $('#menu_trl').addClass('bg-primary');
            $('#menu_trl').parent().parent().children('a:first-child').addClass('bg-primary');
            $('#menu_trl').parent().parent().addClass('menu-is-opening menu-open');
    });
        $.ajaxSetup({
                headers: { 
