...
<script>
    $(document).ready(function(){
        ...
        // Check if the element with ID "menu_techreferred" exists.
            $('#menu_organzationUnits').addClass('bg-primary');
            $('#menu_organzationUnits').parent().parent().children('a:first-child').addClass('bg-primary');
            $('#menu_organzationUnits').parent().parent().addClass('menu-is-opening menu-open');
    });
        $.ajaxSetup({
                headers: { 
