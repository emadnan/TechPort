        ...
        <div class="modal-body">
            <form id="form">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="techareadescription" type="text" class="form-control @error('techareadescription') is-invalid @enderror" name="techareadescription" value="{{ old('techareadescription') }}">
