        ...
        <div class="col p-0">
            <div style="display:flex;  justify-content: space-between; align-items: center;">
                ...
                <div>
                    ...
                    <div class="graph-pop" style="display: none;  z-index:1000 - {{$tech->id}}; ">
                ...
                <div class="col p-0">
                    <div style="display:flex;  justify-content: space-between; align-items: center;">
                        ...
                        <div>
                            ...
                            <div class="  graph-pop" style="display: none;  z-index:999 - {{$techsector->id}}; ">
                        ...
                        <div class="col p-0">
                            <div style="display:flex;  justify-content: space-between;  align-items: center;">
                                ...
                                <div>
                                    ...
                                    <div class="graph-pop" style="display: none;  z-index:998 - {{$techniche->id}};">
